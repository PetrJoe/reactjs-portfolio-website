    ...
    <>
      <div className="px-2 py-12 mt-16 flex flex-col justify-center items-center text-center">
        ...
        <ul className="flex flex-row mt-2">
          <li className="mx-2">
            <a href="https://github.com/PetrJoe" target="_blank" aria-label="GitHub">
              ...
              <div className="mt-6 m-auto space-y-6 md:w-8/12 lg:w-7/12">
                ...
                <div className="flex flex-wrap justify-center gap-6">
                    <a href="#"
                      ...
                      <span className="relative text-base font-semibold text-teal-500 dark:text-white">Get Started</span>
                    </a>
                </div>
              </div>
            </div>
